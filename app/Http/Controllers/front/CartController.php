...
class CartController extends Controller
{
    ...
    public function index() {
        ...
        $userinfo = User::select('name','email','mobile')->where('id',$user_id)
        ->get()->first();
        ...
        return view('front.cart', compact('cartdata','getabout','taxval','userinfo','getdata','getpaymentdata','addressdata','branch','getinfo'));
    }
