    ...
    <table cellpadding="0" cellspacing="0" style="width: 100%;line-height: inherit;text-align: left;">
        ...
        <tr>
            ...
            <td style="padding: 5px;vertical-align: top;border-bottom: 1px solid #eee;">
                ...
                @if (isset($orders['addons']) && $orders['addons'] != "")
                  ...
                  <b>{{$addons['name']}}</b> : {{$currency}}{{number_format($addons['price'], 3)}}<br>
            ...
            <td style="padding: 5px;vertical-align: top;border-bottom: 1px solid #eee;">
                {{$currency}}{{number_format($orders['variation_price'], 3)}}
            </td>
            <td style="padding: 5px;vertical-align: top;border-bottom: 1px solid #eee;">
                {{$orders['qty']}}
            </td>            
            <td style="padding: 5px;vertical-align: top;text-align: right;border-bottom: 1px solid #eee;">
                {{$currency}}{{number_format($orders['total_price'], 3)}}
            </td>
        </tr>
        <?php
        ...
        <tr>
            ...
            <td style="padding: 5px;vertical-align: top;text-align: right;border-top: 2px solid #eee;font-weight: bold;">
               <strong>Subtotal</strong> : {{$currency}}{{number_format($order_total, 3)}}
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="padding: 5px;vertical-align: top;text-align: right;border-top: 2px solid #eee;font-weight: bold;">
               <strong>Tax</strong> ({{$getusers->tax}}%) : {{$currency}}{{number_format($getusers->tax_amount, 3)}}
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="padding: 5px;vertical-align: top;text-align: right;border-top: 2px solid #eee;font-weight: bold;">
               Delivery Charge : {{$currency}}{{number_format($getusers->delivery_charge, 3)}}
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="padding: 5px;vertical-align: top;text-align: right;border-top: 2px solid #eee;font-weight: bold;">
               <strong>Discount</strong> ({{$getusers->promocode}}) : - {{$currency}}{{number_format($getusers->discount_amount, 3)}}
            </td>
        </tr>
        @endif
        ...
        <tr>
            ...
            <td style="padding: 5px;vertical-align: top;text-align: right;border-top: 2px solid #eee;font-weight: bold;">
               Total : {{$currency}}{{number_format($getusers->order_total, 3)}}
            </td>
        </tr>
    </table>
</div>