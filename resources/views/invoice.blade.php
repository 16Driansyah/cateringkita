                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="left strong">
                                ...
                                <div class="cart-addons-wrap">
                                    <div class="cart-addons">
                                        <b>{{$addons['name']}}</b> : {{Auth::user()->currency}}{{number_format($addons['price'], 3)}}
                                    </div>
                                </div>
                                @endforeach
                            ...
                            <td class="left">{{Auth::user()->currency}}{{number_format($orders->variation_price, 3)}}</td>
                            <td class="center">{{$orders->qty}}</td>
                            <td class="right">{{Auth::user()->currency}}{{number_format($orders->total_price, 3)}}</td>
                        </tr>
                        <?php
                            $data[] = array(
                    ...
                    <table class="table table-clear">
                        <tbody>
                            <tr>
                                ...
                                <td class="right">
                                    <strong>{{Auth::user()->currency}}{{number_format($getusers->tax_amount, 3)}}</strong>
                                </td>
                            </tr>
                            <tr>
                                <td class="left">
                                ...
                                <td class="right">
                                    <strong>{{Auth::user()->currency}}{{number_format($getusers->delivery_charge, 3)}}</strong>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="right">
                                    <strong> - {{Auth::user()->currency}}{{number_format($getusers->discount_amount, 3)}}</strong>
                                </td>
                            </tr>
                            @endif
                            <tr>
                                ...
                                <td class="right">
                                    <strong>{{Auth::user()->currency}}{{number_format($getusers->order_total, 3)}}</strong>
                                </td>
                            </tr>
                        </tbody>
                    </table>
