    ...
    <div class="modal-content">
      ...
      <div id="errorr" style="color: red;"></div>
        ...
        <div class="modal-body">
            ...
            <p style="color: #464648;font-size: 16px;font-weight: 500;margin-bottom: 0; text-align: center;">Share this code with a friend and you both could be eligible for bonus amount under our Referral Program.</p>
            <hr>
